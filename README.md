# `OpenSSL_CLI_jll.jl` (v3.5.1+0)

[![deps](https://juliahub.com/docs/OpenSSL_CLI_jll/deps.svg)](https://juliahub.com/ui/Packages/General/OpenSSL_CLI_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/395aa72fedad9ef3d601272659b8e3c90f5c96a1/O/OpenSSL/OpenSSL_CLI@3.5/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
`OpenSSL_CLI_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `OpenSSL_CLI_jll.jl`:
